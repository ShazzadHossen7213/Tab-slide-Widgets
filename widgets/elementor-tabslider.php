...
class Elementor_Tabslide_Widget extends \Elementor\Widget_Base
{

    public function get_name()
    {
        return 'Tab slide Widget';
    }

    public function get_title()
    {
        return esc_html__('Tab slide Widget', 'custom-tab');
    }
